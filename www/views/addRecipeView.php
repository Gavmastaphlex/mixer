...
class AddRecipeView extends View {
    ...
    protected function displayContent() {
        	...
        	$html = '<h2 id="addRecipeHeading">'.$this -> pageInfo['pageHeading'].'</h2>'."\n";
            ...
            */
		    ...
		    /*
			If $_POST['form'] is true then the user has filled out one of the three sections of the Add Recipe Process
            ...
            */
			...
			referes to any "New Ingredients" that they have created using the "Add New Ingredient" input
            ...
            */
			...
			through the steps of adding a recipe) - Line 94 is carried out where form validation
			...
			will generate and be displayed in their places that are written into the code
	       	...
	       	*/
	       	...
	       	/*
			The following code will display the FIRST PART of the Add Recipe Process, but will first check to see if :
			|
			|
			V
			1 - The user is coming to the first step from the User Panel View // or coming back from the second step.
			2 - The user is trying to go to the second step but there is validation errors
			3 - The user has previewed the Recipe right at the end of the Add Recipe procedure, and then clicked the link to go back to the first step.
	       	*/
        	if($_POST['firstStep'] || $_POST['secondStep'] && $vresult['ok'] == false || $_GET['step'] == 'one') {
			...
			$html .= '<form method="post" action="index.php?page=addRecipe#recipeForm" enctype="multipart/form-data">'."\n";
		    ...
		    if($_SESSION['newRecipe']['recipeImage']) {
			    $html .= '<div id="recipeThumbnailImage">'."\n";
			   	$html .= '<img src="tempUploads/thumbnails/'.$_SESSION['newRecipe']['recipeImage'].'" /></div>'."\n";
		   	}	
	    	...
	    	/*
			The following code will display the SECOND PART of the Add Recipe Process, but will first check to see if :
			|
			|
			V
			...
			7 - The user has previewed the Recipe right at the end of the Add Recipe procedure, and then clicked the link to go back to the second step.
			8 - The user has clicked the button to delete a New Ingredient that they have loaded during this Add Recipe session.
	       	*/
	        if($_POST['backToSecondStep'] || $_POST['secondStep'] && $vresult['ok'] || $_POST['thirdStep'] && $vresult['ok'] == false || $_POST['newIngredientNameButton'] || $_POST['confirmIngredientBtn'] || $_POST['deleteConfirmedIngredient'] || $_GET['step'] == 'two' || $_POST['deleteNewIngredientBtn']){
				...
				*/
				...
				3 - The user has previewed the Recipe right at the end of the Add Recipe procedure, and then clicked the link to go back to the third step.
	       		*/
	        	if($_POST['previewRecipe'] || $_POST['thirdStep'] && $vresult['ok'] || $_GET['step'] == 'three') {
	        		...
	        		*/
	        		if($_POST['previewRecipe'] || $_POST['backToSecondStep']) {
	        		$_SESSION['newRecipe']['recipeMethod'] = strip_tags($_POST['recipeMethod']);
	        	}
    ...
    private function displayConfirmedIngredients($confirmedIngredient) {
        ...
        foreach($confirmedIngredient as $confirmed) {
        	...
        	/*
            This function takes all the ingredients that the user has confirmed in the Add Recipe process, loops
            ...
            */
			...
			$html .= '<form method="post" action="index.php?page=addRecipe#recipeForm">';
